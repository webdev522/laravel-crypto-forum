                ...
                @foreach($posts as $post)
                    <div class="row">
                        <div class="col-md-2 col-sm-2 col-xs-12 reply col-img">
                            <div class="user-profile">
                                <img class="profile-img img-responsive img-thumbnail" src=" {{($post->p_img)? config('app.url')."storage/profile_images/".$post->p_user_id.".".$post->p_img:asset('assets/img/user.png')}}">
                                <div class="profile-display hide">
                                    <a onclick="add_fav('{{$post->p_user_id}}')" ><img class="heart img-responsive"  src=" {{asset('assets/img/heart.png')}}"></a>
                                    <h5 class="view-profile">View Profile</h5>
                                </div>
                            </div>
                            <div class="username">                    
                                <h4> <img src="{{asset('assets/img/crown.gif')}}" alt=""> <a href="#">{{$post->p_first_name." ".$post->p_last_name}}</a></h4>
                                <h4 style="text-align:center;">{{$post->u_posts." Posts"}}</h4>
                             </div>
                        </div>
                        <div class="col-md-10 col-sm-10 col-xs-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                <p class="pull-right">{{$post->p_updated_at}}</p>
                                </div>
                            </div>

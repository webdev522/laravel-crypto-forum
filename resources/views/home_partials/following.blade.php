<p>View as: <a href="">Follow</a></p>
 <hr>
 <div class="tab-content clearfix" >
   
    @foreach($follows as $follow)
        @if(isset($follow->threads->id) && $follow->threads->id!=null)
            ...
            <div class="container-fluid" style=" padding-left: 0px !important;">
                <div class="">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-5 col-img">
                        ...
                        <div class="username">                    
                                <h4> <img src="{{asset('assets/img/crown.gif')}}" alt=""> <a href="#">{{$follow->threads->user->first_name.' '.$follow->threads->user->last_name}}</a></h4>
                                <h4 style="text-align:center;">{{$follow->threads->user->u_posts}} Posts</h4>
                        </div>
                    </div>
                    ...
                    <div class="col-md-10 col-sm-10 col-xs-12">
                        <div class="row">
                            <div class="col-sm-8">
                                <p style="font-size: 14px;color: #3077b5 !important;"> <a href="{{route('home',$follow->threads->slug)}}">{{$follow->threads->slug}}</a> > <a href="{{route('home',$follow->threads->slug)}}/{{$follow->threads->id}}">{{$follow->threads->title}}</a> </p>
                            </div>
                            <div class="col-sm-4">
                                <p style="color: black !important" class="pull-right">{{$follow->threads->updated_at}}</p>
                            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="">
                    ...
                    <div class="col-md-2">
                        {{--<p class="pull-right">{{$follow->threads->t_updated_at}}</p>--}}
                    </div>
                </div>
